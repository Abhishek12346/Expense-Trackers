...
dataentery_frame_bg = 'Sky Blue'  # Change from 'Red' to 'SkyBlue'
buttons_frame_bg = 'Sky Blue'
hlb_btn_bg = 'Blue'
...
Button(buttons_frame, text='Clear Fields in DataEntry Frame', font=btn_font, width=25, bg=hlb_btn_bg,
       command=clear_fields).place(x=640, y=5)

Button(buttons_frame, text='Edit Selected Expense', command=edit_expense, font=btn_font, width=25, bg=hlb_btn_bg).place(x=30, y=65)
